...
exports.calcularTarifaUnitaria = calcularTarifaUnitaria;
exports.calcularMediaConsumo = calcularMediaConsumo;
exports.calcularDiferencaPercentual = calcularDiferencaPercentual;
exports.calcularTributosPercentual = calcularTributosPercentual;
exports.decimalToNumber = decimalToNumber;
exports.gerarCodigoRelatorio = gerarCodigoRelatorio;
/**
 * Calcula a tarifa unitária (R$/kWh)
 * Fórmula: valor_total / consumo_kwh
 */
function calcularTarifaUnitaria(valorTotal, consumoKwh) {
 ...
 */
function calcularMediaConsumo(consumoAtual, consumoAnterior) {
    if (consumoAtual == null || consumoAnterior == null)
        return null;
 ...
 */
function calcularDiferencaPercentual(consumoAtual, consumoAnterior) {
    if (!consumoAnterior || consumoAnterior === 0)
        return null;
 ...
 */
function calcularTributosPercentual(valorTotal, consumoKwh, tarifaUnitaria, valorCip) {
 ...
 */
function gerarCodigoRelatorio(periodoReferencia, sequencial) {
